						...
						<div class="box">
							...
							%>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input id="firstname" type="text" class="form-control" name="uName" maxlength="200" value="<%=bean.getProductName()%>">
											</div>
										</div>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input class="form-control" type="text" required="required" name="uPrice" size="20"
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input class="form-control" type="text" required="required" name="uAmount" size="20"
									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<label><input type="checkbox" name="upayType" value=2 />純寄送(先匯款)</label> 
										...
										<div class="col-md-12">
											<div class="form-group">
												...
												<textarea name="uDescription" rows="6" cols="40"
								...
								<div class="box-footer" align = "right">
									...
									<input type="submit" name="productUpdateOrDelete" value="更新" class="btn btn-outline-secondary btn-info">
