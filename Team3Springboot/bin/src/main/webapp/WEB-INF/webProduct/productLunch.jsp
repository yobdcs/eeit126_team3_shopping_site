							...
							<form action="lunchProduct" method="post" enctype="multipart/form-data">
								...
								<div class="content py-3">
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="hidden" name="pAccount" size="20" maxlength="20" required="required" />
												<input id="firstname" type="text" class="form-control" name="pName" maxlength="200" />
											</div>
										</div>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label for="company">商品價格</label> <input
													class="form-control" type="text" required="required"
													name="pPrice" size="20" maxlength="8"
													oninput="value=value.replace(/[^\d]/g,'')" />
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label for="street">商品數量</label> <input class="form-control"
													type="text" required="required" name="pAmount" size="20"
									...
									<div class="row">
										<div class="col-md-6 col-lg-3">
											<div class="form-group">
												<label for="city">商品狀況</label> <select name="pType" size="1"
													class="form-control">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<label><input type="checkbox" name="payType" value=2 />純寄送(先匯款)</label> 
										...
										<div class="col-md-12">
											<div class="form-group">
												...
												<textarea name="pDescription" rows="6" cols="40"
								...
								<div class="box-footer d-flex justify-content-between">
									...
									<input type="submit" name="productOnSubmit" value="送出" class="btn btn-primary">
