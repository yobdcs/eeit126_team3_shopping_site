			...
			<div class="row">
				...
				<div class="col-lg-6 text-center text-lg-right">
					<ul class="menu list-inline mb-0">
						...
						<li class="list-inline-item" id="regLi"><a href="insertpage.controller">Register</a></li>
						<li class="list-inline-item"><a href="#">Contact</a></li>
						<li class="list-inline-item"><a href="<c:url value="/ShowAll.controller" />">Recently viewed</a></li>
					</ul>
				</div>
			</div>
		</div>
					...
					<div class="modal-body">
						<!-- <form action="#" method="get"> -->
							<div class="form-group">
								<input id="email-modal" type="text" placeholder="account"
									class="form-control">
							</div>
							<div class="form-group">
						...
						<p class="text-center text-muted">
							Not registered yet?<br><a href="#"><strong>Register now</strong></a>! It is
...
<!-- 					<li class="nav-item dropdown menu-large"><a href="#"
							...
							<li>
								<div class="row">
									<div class="col-md-6 col-lg-3">
										<h5>Shop</h5>
										<ul class="list-unstyled mb-3">
											<li class="nav-item"><a href="<c:url value='/' />" class="nav-link">Homepage</a></li>
	...
	<div id="search" class="collapse">
		...
		<iframe id="fileloader" src="distribution/products_names.txt" onload="start()" style="display: none;"></iframe>
...
<script src="/Team03ShoppingSite/js/autocomplete.js"></script>
<script>
//window.onload = function(){
	...
	if(ss.length != 0){
		...
		loginLi.innerHTML="<a>Weclome: </a><a href=''>"+ss+"</a>";
		regLi.innerHTML="<a href='javascript:' id='a'>Logout</a>";
